        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          <div>
            ...
            <ul className="space-y-3">
              {[['Inicio', '/#inicio'], ['Nosotros', '/#nosotros'], ['Productos', '/#productos'], ['FAQ', '/#faq']].map(([label, href]) => (
                <li key={label}>
                  <a href={href} className="text-[#7F997C] text-sm hover:text-white transition-colors">{label}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={slug}>
                  <Link href={`/categoria/${slug}`} className="flex items-center gap-2 text-[#7F997C] text-sm hover:text-white transition-colors group">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-[#7F997C]">
              ...
              <li>
                <a href="https://wa.me/5493513662570" className="flex items-center gap-2 hover:text-white transition-colors">
              ...
              <li>
                <a href="https://www.instagram.com/ff.mates/" target="_blank" rel="noreferrer" className="flex items-center gap-2 hover:text-white transition-colors">
                  <svg className="w-4 h-4 text-[#4C674A] flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/politica-de-privacidad" className="text-[#7F997C] text-sm hover:text-white transition-colors">
                  Política de privacidad
                </Link>
              </li>
              <li>
                <Link href="/terminos-y-condiciones" className="text-[#7F997C] text-sm hover:text-white transition-colors">
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-6 flex flex-col md:flex-row justify-between items-center gap-3">
          ...
          <p className="text-[#4C674A] text-xs">
            ...
            <a href="https://www.linkedin.com/in/facundo-bisio-25a104247/" target="_blank" rel="noreferrer" className="text-[#7F997C] hover:text-white transition-colors font-medium">
              Facundo Bisio
            </a>
          </p>
        </div>
