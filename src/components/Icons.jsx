...
export function RedesSociales () {
    return (
        <div className="flex justify-center space-x-6 mt-6">
            <a href="https://www.instagram.com/ff.mates/?hl=es" className="text-orange-400 text-2xl hover:scale-110 transition">
            ...
            <a href="https://wa.me/5493513662570" className="text-orange-400 text-2xl hover:scale-110 transition">
