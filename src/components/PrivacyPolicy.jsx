...
const PrivacyPolicy = () => {
  ...
  return (
    ...
    <div className="container mx-auto px-6 py-12 pt-32 max-w-4xl min-h-screen">
      <h1 className="text-4xl font-bold text-brand-dark mb-8 border-b-2 border-orange-200 pb-4">
        Política de Privacidad
      </h1>
      
      <div className="prose prose-orange max-w-none text-gray-700">
        <p className="mb-4">
          En <strong className="text-brand-light">FFMates</strong>, valoramos tu privacidad y nos comprometemos a proteger tus datos personales. 
          Esta política explica cómo recopilamos, usamos y protegemos tu información.
        </p>

        <h3 className="text-xl font-bold text-brand-dark mt-6 mb-2">1. Información que Recopilamos</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-bold text-brand-dark mt-6 mb-2">2. Uso de la Información</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-bold text-brand-dark mt-6 mb-2">3. Cookies y Tecnologías</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-bold text-brand-dark mt-6 mb-2">4. Contacto</h3>
        <p className="mb-8">
        ...
        <Link to="/" className="inline-block bg-brand-light text-brand-dark px-6 py-2 rounded-lg hover:bg-brand-light/60 transition font-semibold">
            Volver al Inicio
        </Link>
      </div>
    </div>
