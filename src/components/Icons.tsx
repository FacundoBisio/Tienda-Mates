...
export const MateIcon = ({ className = 'w-5 h-5', style }: IconProps) => (
  <svg className={className} style={style} {...SVG_PROPS}>
...
export const ThermoIcon = ({ className = 'w-5 h-5', style }: IconProps) => (
  <svg className={className} style={style} {...SVG_PROPS}>
...
export const LeafIcon = ({ className = 'w-5 h-5', style }: IconProps) => (
  <svg className={className} style={style} {...SVG_PROPS}>
...
export const BombillaIcon = ({ className = 'w-5 h-5', style }: IconProps) => (
  <svg className={className} style={style} {...SVG_PROPS}>
...
export const BagIcon = ({ className = 'w-5 h-5', style }: IconProps) => (
  <svg className={className} style={style} {...SVG_PROPS}>
...
export const BoxIcon = ({ className = 'w-5 h-5', style }: IconProps) => (
  <svg className={className} style={style} {...SVG_PROPS}>
...
export const TruckIcon = ({ className = 'w-5 h-5', style }: IconProps) => (
  <svg className={className} style={style} {...SVG_PROPS}>
...
export const ChatIcon = ({ className = 'w-5 h-5', style }: IconProps) => (
  <svg className={className} style={style} {...SVG_PROPS}>
    <path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/>
  </svg>
);

export const LockIcon = ({ className = 'w-5 h-5', style }: IconProps) => (
  <svg className={className} style={style} {...SVG_PROPS}>
...
export const CraftIcon = ({ className = 'w-5 h-5', style }: IconProps) => (
  <svg className={className} style={style} {...SVG_PROPS}>
    <path d="M12 20h9"/>
...
export const ShieldIcon = ({ className = 'w-5 h-5', style }: IconProps) => (
  <svg className={className} style={style} {...SVG_PROPS}>
...
export const MapPinIcon = ({ className = 'w-5 h-5', style }: IconProps) => (
  <svg className={className} style={style} {...SVG_PROPS}>
...
export const UsersIcon = ({ className = 'w-5 h-5', style }: IconProps) => (
  <svg className={className} style={style} {...SVG_PROPS}>
