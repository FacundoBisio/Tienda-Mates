  ...
  MATES: {
    ...
    Imperiales: [
      ...
      },
      {
        ...
        description: 'Imperial tipo vasija esférica envuelta en cuero natural minuciosamente tallado.',
        stock: 2
      },
      {
        id: 'imperial-new-23',
        ...
        description: 'Hermoso mate tallado sobre cuero marrón. No cuenta con patas de base.',
        stock: 2
      },
      {
        id: 'imperial-new-24',
        ...
        description: 'Llamativo mate esférico forrado en cuero rojo, con decoración tallada.',
        stock: 2
      },
      {
        id: 'imperial-new-5',
      ...
      },
      {
        ...
        description: 'Elegancia clásica en color marrón con una cómoda base redonda para mayor soporte.',
        stock: 2
      },
      {
        id: 'imperial-new-7',
        ...
        description: 'Imperial en cuero negro con base redonda, un diseño imponente y ergonómico.',
        stock: 2
      },
      {
        id: 'imperial-new-8',
        ...
        description: 'Mate Imperial forrado en cuero rojo premium con sistema de base redonda.',
        stock: 2
      },
      {
        id: 'imperial-new-16',
      ...
      },
      {
        ...
        description: 'Mate Imperial clásico en cuero vacuno marrón, con virola artística cincelada.',
        stock: 2
      },
      {
        id: 'imperial-new-12',
        ...
        description: 'Diseño prémium con virola cincelada y base redonda. El equilibrio perfecto.',
        stock: 2
      },
      {
        id: 'imperial-new-13',
        ...
        description: 'Majestuoso Mate Imperial que integra base de apoyo y una increíble virola labrada.',
        stock: 2
      },
      {
        id: 'imperial-new-14',
        ...
        description: 'Edición especial rojo profundo con acabados cincelados a mano y base reforzada.',
        stock: 2
      },
      {
        id: 'imperial-new-17',
    ...
    Torpedos: [
      ...
      },
      {
        ...
        description: 'Mate Torpedo de tamaño compacto. Especial para cebadas cortas y cómodas.',
        stock: 2
      },
      {
        id: 'torpedo-new-3',
      ...
      },
      {
        ...
        description: 'Precioso Torpedo con un relieve temático que forma una hermosa flor en el cuero.',
        stock: 2
      },
      {
        id: 'torpedo-new-13',
  ...
  BOMBILLAS: [
    {
      ...
      href: 'Bombilla',
      description: 'Bombilla tradicional de excelente material térmico, ideal para todo tipo de mate.',
      stock: 5
    },
    {
      id: 'bombilla-new-2',
      ...
      description: 'Bombilla con detalles decorativos (apliques) que le otorgan un toque rústico y elegante.',
      stock: 5
    },
    {
      id: 'bombilla-new-3',
      ...
      href: 'BombillaDorada',
      description: 'Elegante bombilla bañada en tono dorado para acompañar mates de alto diseño.',
      stock: 5
    },
    {
      id: 'bombilla-new-4',
      ...
      href: 'Bombillon',
      description: 'Bombillón de gran caudal tipo "bomba". Ideal para mates grandes y yerbas finas uruguayas.',
      stock: 5
    },
    {
      id: 'bombilla-new-5',
      ...
      description: 'Bombillón de categoría, con fuste trenzado a mano logrando mayor rigidez y atractivo.',
      stock: 5
    },
    {
      id: 'bombilla-new-6',
      ...
      description: 'Segunda variante de nuestro exitoso Bombillón Trenzado, con detalles únicos.',
      stock: 5
    },
    {
      id: 'bombilla-new-7',
      ...
      description: 'Modelo largo de 19 cm, ideal para mates imperiales o camioneros grandes.',
      stock: 5
    },
    {
      id: 'bombilla-new-8',
      ...
      description: 'Bombillón premium con detalle conmemorativo de Belgrano en el fuste.',
      stock: 5
    },
    {
      id: 'bombilla-new-9',
      ...
      href: 'BombillonBoca',
      description: 'Bombillón de gran grosor con aplique exclusivo del Xeneize.',
      stock: 5
    },
    {
      id: 'bombilla-new-10',
      ...
      description: 'Diseño trenzado imponente adornado con aplicaciones doradas de máxima calidad.',
      stock: 5
    },
    {
      id: 'bombilla-new-11',
      ...
      description: 'Bombillón 100% alpaca trabajado meticulosamente a mano por orfebres.',
      stock: 5
    },
    {
      id: 'bombilla-new-12',
      ...
      description: 'La máxima distinción. Bombillón grueso bañado en oro con espectaculares apliques.',
      stock: 5
    }
  ],
  ACCESORIOS: [
    {
      id: 'accesorios-new-1',
      name: 'Matera Auto Cuero',
      price: '18000',
      image: '/images/accesorios/MateraAutoCuero.jpeg',
      href: 'MateraAutoCuero',
      description: 'Matera compacta y ergonómica, pensada especialmente para llevar en el vehículo.',
      stock: 2
    },
    {
      id: 'accesorios-new-2',
      name: 'Matera Auto Cuero Crudo',
      price: '22000',
      image: '/images/accesorios/MateraAutoCueroCrudo.jpeg',
      href: 'MateraAutoCueroCrudo',
      description: 'Matera de automóvil confeccionada en rústico e indomable cuero crudo.',
      stock: 2
    },
    {
      id: 'accesorios-new-3',
      name: 'Matera Eco Cuero',
      price: '25000',
      image: '/images/accesorios/MateraEcoCuero.jpeg',
      href: 'MateraEcoCuero',
      description: 'Matera amplia fabricada en resistente ecocuero de primera línea.',
      stock: 2
    },
    {
      id: 'accesorios-new-4',
      name: 'Media Matera Cuero',
      price: '32000',
      image: '/images/accesorios/MediaMateraCuero.jpeg',
      href: 'MediaMateraCuero',
      description: 'Modelo tipo "media matera" súper práctica. Entra tu termo, mate y yerbera cómodamente.',
      stock: 2
    },
    {
      id: 'accesorios-new-5',
      name: 'Media Matera Cuero 2',
      price: '32000',
      image: '/images/accesorios/MediaMateraCuero2.jpeg',
      href: 'MediaMateraCuero2',
      description: 'Bordados y terminaciones diferentes en nuestra versión alterna de la media matera.',
      stock: 2
    },
    {
      id: 'accesorios-new-6',
      name: 'Media Matera Cuero Marrón',
      price: '32000',
      image: '/images/accesorios/MediaMateraCueroMarron.jpeg',
      href: 'MediaMateraCueroMarron',
      description: 'Media matera en cuero genuino color marrón natural.',
      stock: 2
    },
    {
      id: 'accesorios-new-7',
      name: 'Media Matera Cuero Rojo',
      price: '32000',
      image: '/images/accesorios/MediaMateraCueroRojo.jpeg',
      href: 'MediaMateraCueroRojo',
      description: 'Media matera forrada completamente en cuero entintado a mano en rojo.',
      stock: 2
    },
    {
      id: 'accesorios-new-8',
      name: 'Media Matera Cuero Rojo Colmena',
      price: '34000',
      image: '/images/accesorios/MediaMateraCueroRojoColmena.jpeg',
      href: 'MediaMateraCueroRojoColmena',
      description: 'Atractivo detalle en estilo panal colmena sobre nuestra matera roja.',
      stock: 2
    },
    {
      id: 'accesorios-new-9',
      name: 'Media Matera Cuero Crudo',
      price: '36000',
      image: '/images/accesorios/MediaMateraCueroCrudo.jpeg',
      href: 'MediaMateraCueroCrudo',
      description: 'El clásico sabor a campo en un formato portátil de alta durabilidad.',
      stock: 2
    },
    {
      id: 'accesorios-new-10',
      name: 'Media Matera Cuero Pelo Blanco',
      price: '38000',
      image: '/images/accesorios/MediaMateraCueroConPielBlanca.jpeg',
      href: 'MediaMateraCueroPeloBlanco',
      description: 'Increíble matera con la vista del cuero natural incluyendo el pelo blanco del animal.',
      stock: 2
    },
    {
      id: 'accesorios-new-11',
      name: 'Media Matera Cuero Pelo Marrón',
      price: '38000',
    ...
    },
    {
      ...
      name: 'Matera Cuero Marrón',
      price: '40000',
      image: '/images/accesorios/MateraCueroMarron.jpeg',
      href: 'MateraCueroMarron',
      description: 'Matera completa (tamaño full) de cuero curtido marrón para termo, yerbera y azucarera.',
      stock: 2
    },
    {
      ...
      description: 'Mochila especialmente diseñada con correas y compartimentos internos para llevar todo tu equipo matero.',
      stock: 2
    },
    {
      ...
      description: 'Formatos modernos tipo mochila para mayor comodidad al transportar, en cuero rojo.',
      stock: 2
    },
    {
      ...
      description: 'Todo lo que necesitás para empezar a cebar (Termo, latas, mate, bombilla y bolso).',
      stock: 2
    }
  ],
  COMBOS: [
